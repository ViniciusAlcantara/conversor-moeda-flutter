...
class ConversaoMoeda extends StatefulWidget {
  @override
  _ConversaoMoedaState createState() => _ConversaoMoedaState();
}

class _ConversaoMoedaState extends State<ConversaoMoeda> {
